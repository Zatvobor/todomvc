...
import { SHOW_ALL, SHOW_ACTIVE } from '../../js/constants/TodoFilters'
...
describe('components', () => {
  describe('Footer', () => {
    ...
    xit('shouldnt show clear button when no completed todos', () => {
      const { output } = setup({ completedCount: 0 })
      const [ , , clear ] = output.props.children
      expect(clear).toBe(undefined)
    })

    xit('should render clear button when completed todos', () => {
    ...
    xit('should call onClearCompleted on clear button click', () => {
